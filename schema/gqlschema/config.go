...
import "github.com/relychan/relixy/schema/baseschema"
...
type RelixyGraphQLConfig struct {
	...
	ScalarTypeMapping map[string]baseschema.PrimitiveType `json:"scalarTypeMapping,omitempty" yaml:"scalarTypeMapping,omitempty"`
}
