...
// RelixyAPIDocument represents the structure of an API document.
type RelixyAPIDocument struct {
	SchemaRef string `json:"$schema,omitempty" yaml:"$schema,omitempty"`
	// Global settings of the proxy.
	Settings RelixySettings `json:"settings" yaml:"settings"`
	// Info represents a specification Info definitions
	// Provides metadata about the API. The metadata MAY be used by tooling as required.
	// - https://spec.openapis.org/oas/v3.1.0#info-object
	Info *RelixyAPIDocumentInfo `json:"info,omitempty" yaml:"info,omitempty"`
	...
	Tags []RelixyTag `json:"tags,omitempty" yaml:"tags,omitempty"`
	...
	Paths orderedmap.OrderedMap[string, *RelixyPathItem] `json:"paths" yaml:"paths"`
}

// JSONSchemaExtend modifies the JSON schema afterwards.
func (RelixyAPIDocument) JSONSchemaExtend(schema *jsonschema.Schema) {
	schema.Properties.
		Set("paths", &jsonschema.Schema{
			...
			AdditionalProperties: &jsonschema.Schema{
				Ref: "#/$defs/RelixyPathItem",
			},
		})
}

// RelixyTag represents a high-level Tag instance for grouping and filtering.
type RelixyTag struct {
	// Name of the tag.
...
func (prt RelixyTag) OAS() *base.Tag {
	return &base.Tag{
		Name:        prt.Name,
		Summary:     prt.Summary,
...
// RelixyComponents is an element to hold various schemas for the document.
type RelixyComponents struct {
...
// RelixyPathItem represents a definition object of an API path item.
type RelixyPathItem struct {
	// Description of the path item.
	Description string `json:"description,omitempty" yaml:"description,omitempty"`
	// Summary of the path item.
	Summary string `json:"summary,omitempty" yaml:"summary,omitempty"`
	// Defines the operation information of the GET method.
	Get *RelixyOperation `json:"get,omitempty" yaml:"get,omitempty"`
	// Defines the operation information of the PUT method.
	Put *RelixyOperation `json:"put,omitempty" yaml:"put,omitempty"`
	// Defines the operation information of the POST method.
	Post *RelixyOperation `json:"post,omitempty" yaml:"post,omitempty"`
	// Defines the operation information of the DELETE method.
	Delete *RelixyOperation `json:"delete,omitempty" yaml:"delete,omitempty"`
	// Defines the operation information of the PATCH method.
	Patch *RelixyOperation `json:"patch,omitempty" yaml:"patch,omitempty"`
	// Common parameters of the path item.
	Parameters []Parameter `json:"parameters,omitempty" yaml:"parameters,omitempty"`
}

// RelixyOperation represents the definition of an API operation.
type RelixyOperation struct {
	...
	Proxy RelixyAction `json:"proxy" yaml:"proxy"`
}
